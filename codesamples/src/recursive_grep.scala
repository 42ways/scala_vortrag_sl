// Scala for the Impatient, Chapter 20, Exercise 3 - 5
// solution from
// https://github.com/calinburloiu/Scala-for-the-Impatient--Exercises/blob/master/src/exercises/c20_actors/FileActors.scala
